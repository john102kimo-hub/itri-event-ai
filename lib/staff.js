...
const VALID_STAFF_INTENTS = ['calendar', 'progress', 'qa', 'geo_status', 'event_analytics', 'create_event', 'training_link', 'setup_richmenu', 'other'];
...
只回傳這個格式的 JSON：
{"intent":"calendar|progress|qa|geo_status|event_analytics|create_event|training_link|setup_richmenu|other","event_ids":["qa/event_analytics/training_link 用，從清單挑 id，最多3個"],"new_event_name":"create_event 才有，新活動名稱","new_event_date":"create_event 才有，YYYY-MM-DD，訊息沒提到就留空字串","confidence":"high|low"}`;
