...
const CONTACT_EXACT_RE = /^(媒體邀訪需求|邀訪需求|邀訪|聯絡窗口|聯繫窗口|窗口分工|媒體聯絡|採訪窗口)[?？!！。]?$|^(邀訪|窗口)(呢|嗎)$/;
...
const INDUSTRY_TREND_EXACT_RE = /^(產業趨勢分析|產業趨勢|最近趨勢|最新趨勢)[?？!！。]?$|^趨勢(呢|嗎)$/;
...
// 「技術」是不同的輸入，不會互相衝突。
const TECH_QUERY_EXACT_RE = /^(想問什麼技術|工研院技術|技術詢問)[?？!！。]?$|^技術(呢|嗎)$/;
