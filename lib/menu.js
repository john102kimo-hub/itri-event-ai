...
const HELP_CAPABILITY_RE = /^(你|妳|這個(帳號|機器人|助理)|小幫手|小特派)\s*(能|可以|會)\s*(幫我|幫上|提供|回答|做)?\s*(什麼|哪些)(忙|事|功能|服務)?(嗎|呢)?[?？!！～~。]?$/;
...
// 回傳 'calendar' | 'switch' | 'help' | 'contacts' | null。
// 順序有意義：help／contacts 用完全比對最嚴格，先判；calendar 跟 switch 互斥度高，誰先都行。
