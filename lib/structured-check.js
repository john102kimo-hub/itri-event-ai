...
export const NUMBER_RE = /\d+(?:[.,]\d+)?\s*(?:%|％|個百分點|億|萬|千|兆|奈米|nm|kg|公斤|公噸|噸|GWh|MWh|kWh|MW|GW|瓦|坪|件|篇|項|倍|人|名|座|支|次|美元|新台幣|NT\$|USD|元)/;

// 西元／民國年都收，格式不要求到日——「2026年9月」「114年9月11日」「2026/09/11」都算。
export const DATE_RE = /\d{2,4}\s*年\s*\d{1,2}\s*月(?:\s*\d{1,2}\s*日)?|\d{4}[/\-]\d{1,2}(?:[/\-]\d{1,2})?/;
